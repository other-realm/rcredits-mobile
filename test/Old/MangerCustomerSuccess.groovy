...
selenium.open("http://127.0.0.1:8100/#/app/demo-people")
selenium.click("id=H6VM010WeHlioM5JZv1O9G")
selenium.click("xpath=(//img[@title='Demo User'])[2]")
selenium.click("//html")
selenium.click("id=scan")
selenium.click("//img[@title='Demo User']")
selenium.click("//ion-view[@id='customerPage']/ion-content/div/div/button")
selenium.click("//table[@id='keypad']/tbody/tr[3]/td")
selenium.click("//table[@id='keypad']/tbody/tr[3]/td[2]")
selenium.click("//table[@id='keypad']/tbody/tr[3]/td[3]")
selenium.click("//section[3]/button")
