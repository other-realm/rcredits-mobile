...
class ManagerManagerFail(unittest.TestCase):
    def setUp(self):
    ...
    def test_manager_manager_fail(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//table[@id='keypad']/tbody/tr[2]/td[2]").click()
        driver.find_element_by_xpath("//table[@id='keypad']/tbody/tr[2]/td[2]").click()
        # ERROR: Caught exception [ERROR: Unsupported command [doubleClick | //table[@id='keypad']/tbody/tr[2]/td[2] | ]]
        driver.find_element_by_xpath("//table[@id='keypad']/tbody/tr[2]/td[2]").click()
